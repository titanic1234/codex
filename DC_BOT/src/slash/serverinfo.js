...
module.exports = {
    data: new SlashCommandBuilder().setName("guild-info").setDescription("Some info about the guild").setDescriptionLocalizations({
        de: "Einige Informationen über den Server"
    }),
